...
import pdf_question_engine as qeng
from attr_keys_list import attr_keys
    ...
    def reset_counts():
        ...
        for key, template in templates.items():
            ...
            if final_dtype == 'Integer':
                if metadata['dataset'] == 'CLEVR-v1.0':
                    # the upper bound of CLEVR dataset is 11, I set it to 30 currently
                    answers = list(range(0, 30))
