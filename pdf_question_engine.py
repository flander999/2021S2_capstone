...
def attr_count_handler(attr_name):
    def attr_count(scene_struct, inputs, side_inputs):
        idx = inputs[0]
        return scene_struct['objects'][idx][attr_name]
    return attr_count
...
execute_handlers = {
    ...
    'word_count': attr_count_handler("word_count"),
